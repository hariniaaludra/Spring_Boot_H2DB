...
public class EmployeeController {
	...
	public ResponseEntity<?> createEmployee(@RequestBody Employee employee) {
		...
		try {
			...
			Employee employeeObj = employeeRepository.save(new Employee(employee.getEmpName(), employee.getEmpId(),
					employee.getEmPhonenumber(), employee.getEmpAddress(), employee.getEmpDoj(), employee.getStatus(),
					employee.getCreatedBy(), employee.getCreatedDate(), employee.getUpdatedBy(),
					employee.getUpdatedDate(), false));
